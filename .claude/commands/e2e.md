...
4. Report results for the three scenarios:
   - `send_and_recv_plugin_webrtc_e2e` — fast-paced (~60s simulated audio, 14× real-time)
   - `realtime_paced_no_dropout_e2e` — real-time paced (~30s, guards against dropout regression)
